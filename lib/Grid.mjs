...
class Grid extends Svg {
  ...
  constructor(domElementId, {maxX, maxY, minX, minY, defaultStyles, scale, gridLineLabels, axisLabels}, options = {}) {
    minX = minX ?? -maxX;
    minY = minY ?? -maxY;
    ...
    this.axisLabels = axisLabels || {x: 'x', y: 'y'};
