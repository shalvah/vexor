import {setStyles, setAttributes, getAndSetAttributes} from "./utils/dom.mjs"
...
export default class Svg extends EventTarget {
  ...
  text(content, attributes, styles = {}) {
    // This is a stub. We can't import Text and reference it here, since Text extends this class (circular dependencies).
    // Workaround: when the Text class is imported, it defines this method properly.
  };
