...
export class DragHandle {
  ...
  updatePointPosition(event) {
    ...
    this.pointSvg.updateAndNotify({
      cx: round(desiredCentrePositionInDom.x - offsets.x, this.svgToBeDragged.allowedIncrements),
      cy: round(desiredCentrePositionInDom.y - offsets.y, this.svgToBeDragged.allowedIncrements),
    });
  }
}
